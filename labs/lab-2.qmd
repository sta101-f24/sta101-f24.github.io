...
3. Once `lab-2.qmd` is where it needs to be, open it, and verify that you can click the "Render" button in `RStudio` and get a PDF file. See [this answer](https://edstem.org/us/courses/64268/discussion/5216372?answer=12080244) on Ed if you want a bit more guidance here;
