...
**Hint:** `result` is a categorical variable, so use a bar plot for the visualization and the `count()` function for calculating the frequencies of *levels* of this variable. Once you have that, this [primer](https://sta101-f24.github.io/computing/computing-barplot.html) may help you get started with the plot.
