...
1.  Go to the **Files** section of our [Canvas page](https://canvas.duke.edu/courses/36641) and download `lab-1.qmd`. This is a template that you will fill in to complete this assignment;

2.  Use these steps to navigate to `RStudio` using the [Duke Container Manager](https://cmgr.oit.duke.edu/containers);
