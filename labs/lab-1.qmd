...
[^1]: `R` is a programming language, like `Python`, `Java`, `C++`, and other things you may have heard of. `RStudio` is a platform for writing `R` an an easy an organized way. It is an example of an *integrated development environment* (IDE).
