...
The following code creates a nifty lil' table that tallies up the number of people in each group and calculated the proportion of people that died versus survived *within each vaccination group*:
