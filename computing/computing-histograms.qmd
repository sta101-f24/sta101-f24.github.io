...
::: callout-note
Recalling the information [here](https://sta101-f24.github.io/computing/computing-file-paths.html), you may have to modify the file path `"~/lecture-2/flint.csv"` to match the particular way you have chosen to name and organize your files and folders.
:::
