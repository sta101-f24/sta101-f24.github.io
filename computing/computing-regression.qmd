...
The syntax in the `fit` commands is like `fit(y ~ x)`. So the variable to the left of the `~` will be treated as the 
response variable ($y$), and the variable to the right will be treated as predictor ($x$).