...
We see that adjusted $R^2$ increased substantially when we added `cover` as a predictor, supporting our intuition that including this covariate to the model improves fit.
