...
$$
\begin{align*}
\widehat{\text{weight}}&=\hat{\beta}_0+\hat{\beta}_1\widehat{\text{volume}}+\hat{\beta}_2\widehat{\text{cover}}\\
&\approx197.96+0.71\cdot\widehat{\text{volume}}-184.05\cdot\widehat{\text{cover}}.
\end{align*}
$$
