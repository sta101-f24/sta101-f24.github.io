...
## Moving files where they need to be
...
From there, you will download them to your computer. The best way to do this is by following the "three dots" on the righthand side of the file name:
...
The Files section in your RStudio instance is like a little Dropbox or Google Drive account that you can use to store you STA101-related files during the semester. I recommend keeping it organized with folders, like this:

![](organize.png){width="551"}

This button creates new folders:

![](new_folder.png){width="533"}
