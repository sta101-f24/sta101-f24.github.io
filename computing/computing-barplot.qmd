...
Furthermore, some folks left this part of the survey blank, and so there income information is missing, which effectively creates a fifth category. Before plotting, let us quickly modify the data to give this income variable a more concise name, as well as making it a proper `factor` type in `R`:
