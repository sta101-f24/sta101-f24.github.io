...
This page contains a prospective outline for the course, but things may change with advanced notice:
...
library(tidyverse)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/1LVWM54A-ag4BgGQ3la4MzPFf34w426HORfBThxsUIeM/edit?usp=sharing")
```
