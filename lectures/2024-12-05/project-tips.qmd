...
-   Check Lab 7 and Take-Home 2 and submit regrade requests;
-   Course and TA evaluations;
-   I will hold office hours every day next week (M - F). When?
-   Project reminders...
    -   We're skipping the peer review. +4 all around!
    -   For technical help on outside material, Ed is best at first;
    -   If you choose to learn new techniques (methods, coding tricks), great! But make sure you carefully cite everything;
    -   ChatGPT-usage policies apply: fine for code if cited; absolutely not for written text;
    -   Final paper in the ballpark of five pages. Code should not appear!
    -   Video: hop on a Zoom call and record it live is probably easiest (no editing);
    -   Due 5PM on 12/15. Grades due 48 hours later.

## Where to now?

-   **STA 210 Regression Analysis**: similar technical level, delivery style, and coding toolkit as 101;

-   **STA 240 Probability for Inference**: calculus-based introduction to probability and the mathematical theory of statistics.
