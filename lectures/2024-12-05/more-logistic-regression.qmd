...
plot(births14$habit == "smoker", births14$weight, 
     ...
     xlab = "",
     xaxt = "n",
     main = "Smoking during pregnancy dataset",
     xlim = c(-0.25, 1.25))
...
![](images/head-neck.jpg){fig-align="center"}
...
![](images/fico.jpg){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](images/machine-bias-petty-theft-1.png){fig-align="center" width="300" height="250"}
:::

::: {.column width="50%"}
![](images/machine-bias-drug-posession-1.png){fig-align="center" width="300" height="250"}
:::
:::
